    ...
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="mt-4 rounded-2xl glass px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Image src="/logo.svg" alt="SH Software Solutions" width={220} height={44} />
            </div>
      ...
      <main className="mx-auto max-w-6xl px-4">
        ...
        <section id="cases" className="py-10">
          <h2 className="hfont text-2xl sm:text-3xl font-semibold">{t.nav.cases}</h2>
        ...
        <section id="about" className="py-10 grid lg:grid-cols-2 gap-6">
          <div className="rounded-2xl glass p-6">
            <h2 className="hfont text-2xl font-semibold">{t.nav.about}</h2>
            <p className="mt-3 text-white/75 leading-relaxed">
              SH Software Solutions bygger robuste løsninger med fokus på performance, sikkerhed og en god udviklingsproces.
              Vi arbejder sprintbaseret og holder dig tæt på fremdriften, så du altid ved hvad næste skridt er.
            </p>
          </div>
        ...
        <footer className="pb-10 text-center text-xs text-white/45">
          © {new Date().getFullYear()} SH Software Solutions
        </footer>
      </main>
